...
export default async function ConsultationsPage(props: Props) {
              ...
              <div className="flex justify-between items-start gap-4">
                <div className="min-w-0">
                  <h3 className="font-semibold truncate">
                    {consult.chief_complaint ? consult.chief_complaint : `Consultation ${consult.id}`}
                  </h3>
                  <p className="text-sm text-gray-600">
                    Submitted: {consult.created_at ? new Date(consult.created_at).toLocaleDateString() : "-"}
                  </p>
                  <p className="text-sm text-gray-600">
                ...
                <Link
                  href={`/${countryCode}/consultations/${consult.id}`}
